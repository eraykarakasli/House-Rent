 <!-- Sol Alt Kart (Karoselli) -->
 <div id="mapCard" class="position-absolute bottom-0 start-0 m-3" style="z-index: 1000; width: 300px;">
        <div class="card h-100 position-relative shadow-sm border-0 rounded-4 overflow-hidden w-100">

            <div class="position-relative">
                <div id="carouselMap1" class="carousel slide" data-bs-ride="false">
                    <div class="carousel-inner rounded" style="height: 180px;">
                        <div class="carousel-item active">
                            <img src="../../assets/evresim.webp" class="d-block w-100" alt="..." style="height: 180px; object-fit: cover;">
                        </div>
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselMap1" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" style="filter: invert(1);" aria-hidden="true"></span>
                        <span class="visually-hidden">Önceki</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselMap1" data-bs-slide="next">

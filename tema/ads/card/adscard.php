<?php $map = isset($_GET['map']) && $_GET['map'] === 'on'; ?>
...
<div class="container mt-4">
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 <?= $map ? 'row-cols-lg-3' : 'row-cols-lg-5' ?> g-4">
                        ...
                        <div id="carouselSatis1" class="carousel slide" data-bs-ride="false">
                            <div class="carousel-inner rounded" style="height: 200px;">
                                <div class="carousel-item active">
                                    <img src="../../assets/evresim.webp" class="d-block w-100" alt="..." style="height: 200px; object-fit: cover;">
                                </div>
                                <div class="carousel-item">
                                    <img src="../../assets/evresim2.webp" class="d-block w-100" alt="..." style="height: 200px; object-fit: cover;">
                                </div>
                                <div class="carousel-item">
                                    <img src="../../assets/evresim3.webp" class="d-block w-100" alt="..." style="height: 200px; object-fit: cover;">
                                </div>
                            </div>
        ...
        <div class="col">
            <a href="../../pages/adsdetail/adsdetail.php" class="text-decoration-none text-dark">
                <div class="card  position-relative shadow-sm border-0 rounded-4 overflow-hidden w-100">

 ...
 <div class="col-md-4 col-lg-3 mb-3">
     <div class="bg-white shadow-sm rounded-4 p-4 h-100">
         ...
         <div class="text-center mb-4">
             <img src="../../assets/proifle.png" width="80" class="rounded-circle mb-2" alt="Profil Resmi">
             <h5 class="fw-semibold mb-0">Eray Karakaşlı</h5>
         </div>
         ...
         <div class="mt-4 pt-3 border-top">
             <a class="nav-link d-flex justify-content-between align-items-center text-danger fw-semibold rounded px-3 py-2" href="#">

<div class="container my-5">
    <div class="d-flex gap-2 align-items-center mb-3">
        <h4 class="fw-bold">Yaşayış Kompleksləri</h4>
    ...
    <div class="position-relative">
        <!-- Slider -->
        <div class="d-flex flex-nowrap overflow-auto gap-3 pb-3 px-2" id="ilanSlider5" style="scroll-behavior: smooth;">
            <!-- Kart örneği -->
            <div class="card position-relative shadow-sm border-0" style="width: 280px; border-radius: 12px; overflow: hidden;">
                <div class="position-relative">
                    <div id="carouselGunluk5" class="carousel slide" data-bs-ride="false">
                        ...
                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselGunluk5" data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" style="filter: invert(1);" aria-hidden="true"></span>
                            <span class="visually-hidden">Önceki</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#carouselGunluk5" data-bs-slide="next">
        ...
        <!-- Navigasyon okları -->
        <button class="btn btn-light position-absolute top-50 start-0 translate-middle-y shadow rounded-circle" onclick="scrollSlider5(-1)">
            <i class="bi bi-chevron-left"></i>
        </button>
        <button class="btn btn-light position-absolute top-50 end-0 translate-middle-y shadow rounded-circle" onclick="scrollSlider5(1)">
            <i class="bi bi-chevron-right"></i>
        </button>
    </div>
    <div class="w-100 text-center">
        <a href="#" class="btn btn-dark btn-sm p-2 fs-6 rounded-3">Yaşayış kompleksləri </a>
    </div>
</div>

<script>
    function scrollSlider5(direction) {
        const slider = document.getElementById('ilanSlider5');

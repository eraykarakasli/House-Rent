<div class="container my-5">
    <div class="d-flex gap-2 align-items-center mb-3">
        <h4 class="fw-bold">Satışda evlər</h4>
    ...
    <div class="position-relative">
        <!-- Slider -->
        <div class="d-flex flex-nowrap overflow-auto gap-3 pb-3 px-2" id="ilanSlider" style="scroll-behavior: smooth;">
            <!-- Kart örneği -->
            <div class="card position-relative shadow-sm border-0" style="width: 280px; border-radius: 12px; overflow: hidden;">
                <div class="position-relative">
                    <div id="carouselEv1" class="carousel slide" data-bs-ride="false">
                        ...
                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselEv1" data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" style="filter: invert(1);" aria-hidden="true"></span>
                            <span class="visually-hidden">Önceki</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#carouselEv1" data-bs-slide="next">
            ...
            <div class="card position-relative shadow-sm border-0" style="width: 280px; border-radius: 12px; overflow: hidden;">
                <div class="position-relative">
                    <div id="carouselEv2" class="carousel slide" data-bs-ride="false">
                        <div class="carousel-inner rounded" style="height: 180px;">
                            <div class="carousel-item active">
                                <img src="assets\evresim4.webp" class="d-block w-100" alt="..." style="height: 180px; object-fit: cover;">
                            </div>
                        ...
                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselEv2" data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" style="filter: invert(1);" aria-hidden="true"></span>
                            <span class="visually-hidden">Önceki</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#carouselEv2" data-bs-slide="next">
                            <span class="carousel-control-next-icon" style="filter: invert(1);" aria-hidden="true"></span>
                            <span class="visually-hidden">Sonraki</span>
                        </button>
                    </div>
        ...
        <!-- Navigasyon okları -->
        <button class="btn btn-light position-absolute top-50 start-0 translate-middle-y shadow rounded-circle" onclick="scrollSlider(-1)">
            <i class="bi bi-chevron-left"></i>
        </button>
        <button class="btn btn-light position-absolute top-50 end-0 translate-middle-y shadow rounded-circle" onclick="scrollSlider(1)">
            <i class="bi bi-chevron-right"></i>
        </button>
    </div>
    <div class="w-100 text-center">
        <a href="#" class="btn btn-dark btn-sm p-2 fs-6 rounded-3">Bütün satışda evlər</a>
    </div>
</div>

<script>
    function scrollSlider(direction) {
        const slider = document.getElementById('ilanSlider');
        const scrollAmount = 320; // Gerekirse testle 300-340 arası ayarla
        slider.scrollBy({
